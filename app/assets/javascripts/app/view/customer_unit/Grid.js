Ext.define('EIM.view.customer_unit.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.customer_unit_grid',

    requires: 'Ext.ux.grid.FiltersFeature',

    title: '客户单位列表',
    store: 'GridCustomerUnits',
    iconCls: 'ttl_grid',
    ...
    initComponent: function() {
        ...
        this.addCustomerUnitButton = Ext.create('Ext.Button', {
            text: '新增客户单位',
            iconCls: 'btn_add',
            action: 'addCustomerUnit'
        });
        ...
        this.bbar = [this.addCustomerUnitButton, '-', this.pagingToolbar];

        this.callParent(arguments);
    },

    getSelectedCustomerUnit: function() {
