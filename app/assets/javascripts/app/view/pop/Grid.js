Ext.define('EIM.view.pop.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pop_grid',
...
//                dataIndex: 'pop_unit>pop_unit_aliases>unit_alias',
            ...
            {
                header: '单位别称',
                dataIndex: 'pop_unit>unit_aliases>unit_alias',
                width: 150,
                sortable: false,
                hidden: true,
                filter: {
            ...
            {
                header: '区域',
                dataIndex: 'pop_unit>city>prvc>area>id',
                width: 50,
                sortable: true,
                filter: {
                    type:'list',
                ...
                renderer: function(value, metaData, record) {
                    return record.get('pop_unit>city>prvc>area>name');
                }
            },
            {
                header: '城市',
                dataIndex: 'pop_unit>city>name',
                width: 50,
                sortable: false,
                filter: {
                    type:'string'
...
//a1 = PopUnit.where("pop_units.name like '%天%'").pluck :id
//a2 = PopUnitAlias.where("pop_unit_aliases.unit_alias like '%天%'").pluck :pop_unit_id
//a=(a1+a2).uniq
//question = a.map{"?"}.join(",")
//Pop.where("pop_units.id in (#{question})", *a).includes(:pop_unit)