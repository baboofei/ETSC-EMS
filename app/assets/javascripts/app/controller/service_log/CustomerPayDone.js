Ext.define('EIM.controller.service_log.CustomerPayDone', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.CustomerPayDoneForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_customer_pay_done_form button[action=save]': {
                click: this.submit
            }
        });
    },
