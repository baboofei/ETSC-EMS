Ext.define('EIM.controller.service_log.ReturnEquipment', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.ReturnEquipmentForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_return_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"return_equipment": Ext.encode(form.getValues())};
