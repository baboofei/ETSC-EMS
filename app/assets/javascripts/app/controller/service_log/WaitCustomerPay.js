Ext.define('EIM.controller.service_log.WaitCustomerPay', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.WaitCustomerPayForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_wait_customer_pay_form button[action=save]': {
                click: this.submit
            }
        });
    },
