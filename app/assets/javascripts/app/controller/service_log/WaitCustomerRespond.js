Ext.define('EIM.controller.service_log.WaitCustomerRespond', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.WaitCustomerRespondForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_wait_customer_respond_form button[action=save]': {
                click: this.submit
            }
        });
    },
