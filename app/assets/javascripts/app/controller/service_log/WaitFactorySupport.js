Ext.define('EIM.controller.service_log.WaitFactorySupport', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.WaitFactorySupportForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_wait_factory_support_form button[action=save]': {
                click: this.submit
            }
        });
    },
