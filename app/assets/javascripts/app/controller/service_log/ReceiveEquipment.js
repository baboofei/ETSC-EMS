Ext.define('EIM.controller.service_log.ReceiveEquipment', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.ReceiveEquipmentForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_receive_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"receive_equipment": Ext.encode(form.getValues())};
