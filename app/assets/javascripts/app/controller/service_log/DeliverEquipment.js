Ext.define('EIM.controller.service_log.DeliverEquipment', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.DeliverEquipmentForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_deliver_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"deliver_equipment": Ext.encode(form.getValues())};

            form.submit({
                url: 'service_logs/add_service_log',
                params: {
                    "type": "deliver_equipment"
                },
