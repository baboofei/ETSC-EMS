Ext.define('EIM.controller.service_log.DeleteEquipment', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.DeleteEquipmentForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_delete_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"delete_equipment": Ext.encode(form.getValues())};
