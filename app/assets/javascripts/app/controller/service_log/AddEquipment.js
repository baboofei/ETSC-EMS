Ext.define('EIM.controller.service_log.AddEquipment', {
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_add_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"add_equipment": Ext.encode(form.getValues())};
...
//                            console.log('------------');
//                            console.log(info_str.split("=>"));
                            dup_log_info_obj[info_str.split("=>")[0]] = info_str.split("=>")[1].replace(/"/g, "").replace(/，/, ",");
                        });
                        dup_log_list_obj_array.push(dup_log_info_obj);
                        console.log(dup_log_list_obj_array);
                    });
