Ext.define('EIM.controller.service_log.ChangeDetachedParts', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.ChangeDetachedPartsForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_change_detached_parts_form button[action=save]': {
                click: this.submit
            }
        });
    },
