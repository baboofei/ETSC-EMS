Ext.define('EIM.controller.service_log.FactorySupportDone', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.FactorySupportDoneForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_factory_support_done_form button[action=save]': {
                click: this.submit
            }
        });
    },
