Ext.define('EIM.controller.service_log.PackageEquipment', {
...
//        'GridServiceLogInsertion'
    ...
    views: [
        'service_log.PackageEquipmentForm'/*,
...
//    }],
    ...
    init: function() {
        ...
        me.control({
            'service_log_package_equipment_form button[action=save]': {
                click: this.submit
            }
        });
    },
    ...
    submit: function(button) {
        ...
        if(form.form.isValid()) {
            ...
            Ext.ComponentQuery.query('functree')[0].serviceLogCache = {"package_equipment": Ext.encode(form.getValues())};

            form.submit({
                url: 'service_logs/add_service_log',
                params: {
                    "type": "package_equipment"
                },
