...
//        'product.Form',
    ...
    productSelectionChange: function(selectionModel, selected) {
        ...
        if(selected.length > 0) {
            ...
            producer_vendor_unit_field.getStore().loadData([{id: record.get('producer>id'), name: record.get('producer>(name|short_name|short_code)')}]);
            ...
            seller_vendor_unit_field.getStore().loadData([[record.get('seller>id'), record.get('seller>(name|short_name|short_code)')]]);
