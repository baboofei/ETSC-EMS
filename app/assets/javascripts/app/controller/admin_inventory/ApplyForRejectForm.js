/**
 * 拆开后单独加载“申请退货”视图用的controller
 */
Ext.define('EIM.controller.admin_inventory.ApplyForRejectForm', {
...
//        'ComboUser'
    ...
    views: [
        'admin_inventory.ApplyForRejectForm'
    ],
    ...
    init: function() {
        ...
        me.control({
            'admin_inventory_apply_for_reject_form button[action=save]': {
                click: this.applyForReject
            }
        });
    },

    applyForReject: function(button) {
        var me = this;
