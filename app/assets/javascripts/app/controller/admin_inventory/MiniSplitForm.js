/**
 * 维修水单用
 * 因为和仓库管理模块里用到的"source_grid"和"target_grid"不一样，所以必须单独写
 * 拆开后单独加载“拆分”视图用的controller
 */
Ext.define('EIM.controller.admin_inventory.MiniSplitForm', {
...
//        'AdminInventorySN'
    ...
    init: function() {
        ...
        me.control({
            'admin_inventory_mini_split_form button[action=save]': {
                click: function(button) {
                    ...
                    var dragged_array = me.getController('service_log.ChangeParts').tempDraggedArray;
                    var source_grid = Ext.ComponentQuery.query('admin_inventory_mini_grid[name=source_grid]')[0];
                    ...
                    win.close();
//                    me.getController('service_log.ChangeParts').checkTargetGrid();
                }
            }
        });
    }
