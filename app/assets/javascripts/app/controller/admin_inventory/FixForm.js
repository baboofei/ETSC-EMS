/**
 * 加载“修好”视图用的controller
 */
Ext.define('EIM.controller.admin_inventory.FixForm', {
    ...
    init: function() {
        ...
        me.control({
            'admin_inventory_fix_form [name=outstock_count]': {
//                change: this.validateNumberByCount
            },
            'admin_inventory_fix_form [name=outstock_numbers]': {
                select: this.validateNumberByNumber
            },
//            'admin_inventory_fix_form button[action=save_damage]': {
            'admin_inventory_fix_form button[action=save_fix]': {
                click: this.submit
            }
        });
    },
