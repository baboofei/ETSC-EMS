...
//            name: 'customer_unit>customer_unit_aliases>unit_alias',
        ...
        {
            name: 'customer_unit>cu_sort',
            type: 'int'
        },
        {
            name: 'customer_unit_sort_id', //
            type: 'int'
        },
        {
            name: 'customer_unit>city>id',
            type: 'int'
        },
        {
            name: 'customer_unit>city>name',
            type: 'string'
        },
        {
            name: 'customer_unit>city>prvc>area>id',
            type: 'int'
        },
        {
            name: 'customer_unit>city>prvc>area>name',
            type: 'string'
        },
        {
            name: 'phone',
