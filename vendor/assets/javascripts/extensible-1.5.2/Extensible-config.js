...
Extensible.Config = {
    ...
    defaults: {
         ...
         */
        extensibleRoot: '/assets/extensible-1.5.2/', // initialized dynamically in getSdkPath()
...
//        console.log(me.extensibleRoot + 'examples/examples.css?_dc=' + Extensible.version);

//        me.includeScript(me.extJsRoot + 'ext' + suffix + '.js');
//        console.log(me.extJsRoot + 'ext' + suffix + '.js');
        me.includeScript(me.extensibleRoot + 'lib/extensible' + suffix + bootstrap + '.js' + cacheBuster);
//        console.log(me.extensibleRoot + 'lib/extensible' + suffix + bootstrap + '.js' + cacheBuster);
//        me.includeScript(me.extensibleRoot + 'examples/examples.js?_dc=' + Extensible.version);
//        console.log(me.extensibleRoot + 'examples/examples.js?_dc=' + Extensible.version);
    }
};
